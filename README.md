...
AI Agent。聊天只能给步骤；要把事办完，还得自己调工具、保住状态，人点了头再接着跑。企业里要落地，卡的多半是这几层：工具能不能信、上下文怎么收、出错怎么停、中断之后怎么续、费用怎么盯。

模型要进日常工作，多半会停在这一层，所以我在把它看清楚。先把循环拆开写——工具、记忆、评测、成本、续跑——再去对照 LangGraph 这类运行时。
